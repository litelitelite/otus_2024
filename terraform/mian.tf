...
resource "yandex_kubernetes_cluster" "k8s-lab" {
  ...
  service_account_id      = yandex_iam_service_account.lite.id
  node_service_account_id = yandex_iam_service_account.lite.id
  depends_on = [
...
resource "yandex_iam_service_account" "lite" {
  name        = local.sa_name
...
resource "yandex_resourcemanager_folder_iam_member" "editor" {
  ...
  role      = "editor"
  member    = "serviceAccount:${yandex_iam_service_account.lite.id}"
}
